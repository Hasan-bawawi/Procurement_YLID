...
namespace procurement_system
{
    public partial class approval_requisition_form : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if ((Session["GroupName"].ToString() == "RF Approval") || (Session["GroupName"].ToString() == "RF AND PO Approval") || (Session["GroupName"].ToString() == "Super Admin") || (Session["GroupName"].ToString() == "Admin Purchasing"))
            {
                if (!IsPostBack)
                {
