<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="expired_page.aspx.cs" Inherits="procurement_system.expired_page" %>
...
<head runat="server">
    ...
    <title>Purchasing System - YLID - Session Page Expired</title>
    <!-- Favicon icon -->
                        ...
                        <div class="error-content">
                            <div class="card mb-0">
                                <div class="card-body text-center">
                                    ...
                                    <h4 class="mt-4">Session Expired</h4>
                                    <p>Your Session page is expired, please login again for continue.</p>
