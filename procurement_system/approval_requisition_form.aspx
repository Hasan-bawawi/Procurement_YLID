                                                                    ...
                                                                    <asp:GridView ID="TableRF_NeedApprovalManager" runat="server" CssClass="table table-striped row-border order-column table-bordered nowrap zero-configuration grid" AutoGenerateColumns="False" Style="width: 100%"
                                                                        ...
                                                                        <Columns>
                                                                            <asp:TemplateField HeaderText="Action">
                                                                                ...
                                                                                <ItemTemplate>
                                                                                    <asp:LinkButton runat="server" ID="btnViewManager" CommandName="Lihat" CommandArgument="<%# Container.DataItemIndex %>" CssClass="btn buttonColorGridview" OnClick="btnViewManager_Click" ToolTip="View Details"><i class="fa fa-search"></i></asp:LinkButton>
                                                                                </ItemTemplate>
                                                                            </asp:TemplateField>
                                                                    ...
                                                                    <asp:GridView ID="TableHistoryApprovalManager" runat="server" CssClass="table table-striped row-border order-column table-bordered nowrap zero-configuration grid" AutoGenerateColumns="False" Style="width: 100%"
                                                                        ...
                                                                        <Columns>
                                                                            <asp:TemplateField HeaderText="Action">
                                                                                ...
                                                                                <ItemStyle CssClass="fixed-column" />
                                                                                <ItemTemplate>
                                                                                    <asp:LinkButton runat="server" ID="btnViewHistoryManager" CommandName="Lihat" CommandArgument="<%# Container.DataItemIndex %>" CssClass="btn buttonColorGridview" OnClick="btnViewHistoryManager_Click" ToolTip="View Details"><i class="fa fa-search"></i></asp:LinkButton>
                                                                                </ItemTemplate>
                                                                            </asp:TemplateField>
                                                                            <asp:BoundField DataField="id" HeaderText="id" />
                                                                            <asp:BoundField DataField="rf_no" HeaderText="RF Number" />
                                                                    ...
                                                                    <asp:GridView ID="TableDivisionGMApproval" runat="server" CssClass="table table-striped row-border order-column table-bordered nowrap zero-configuration grid" AutoGenerateColumns="False" Style="width: 100%"
                                                                        ...
                                                                        <Columns>
                                                                            <asp:TemplateField HeaderText="Action">
                                                                                ...
                                                                                <ItemStyle CssClass="fixed-column" />
                                                                                <ItemTemplate>
                                                                                    <asp:LinkButton runat="server" ID="btnViewDivisionGM" CommandName="Lihat" CommandArgument="<%# Container.DataItemIndex %>" CssClass="btn buttonColorGridview" OnClick="btnViewDivisionGM_Click" ToolTip="View Details"><i class="fa fa-search"></i></asp:LinkButton>
                                                                                </ItemTemplate>
                                                                            </asp:TemplateField>
                                                                            <asp:BoundField DataField="id" HeaderText="id" />
                                                                            <asp:BoundField DataField="catalog_type" HeaderText="Catalog Type" />
                                                                    ...
                                                                    <asp:GridView ID="TableHistoryDivisionGMApproval" runat="server" CssClass="table table-striped row-border order-column table-bordered nowrap zero-configuration grid" AutoGenerateColumns="False" Style="width: 100%"
                                                                        ...
                                                                        <Columns>
                                                                            <asp:TemplateField HeaderText="Action">
                                                                                ...
                                                                                <ItemStyle CssClass="fixed-column" />
                                                                                <ItemTemplate>
                                                                                    <asp:LinkButton runat="server" ID="btnViewHistoryDivisionGM" CommandName="Lihat" CommandArgument="<%# Container.DataItemIndex %>" CssClass="btn buttonColorGridview" OnClick="btnViewHistoryDivisionGM_Click" ToolTip="View Details"><i class="fa fa-search"></i></asp:LinkButton>
                                                                                </ItemTemplate>
                                                                            </asp:TemplateField>
                                                                            <asp:BoundField DataField="id" HeaderText="id" />
                                                                            <asp:BoundField DataField="rf_no" HeaderText="RF Number" />
                                                                    ...
                                                                    <asp:GridView ID="TableDeputyDirectorApproval" runat="server" CssClass="table table-striped row-border order-column table-bordered nowrap zero-configuration grid" AutoGenerateColumns="False" Style="width: 100%"
                                                                        ...
                                                                        <Columns>
                                                                            <asp:TemplateField HeaderText="Action">
                                                                                ...
                                                                                <ItemStyle CssClass="fixed-column" />
                                                                                <ItemTemplate>
                                                                                    <asp:LinkButton runat="server" ID="btnViewDeputyDirector" CommandName="Lihat" CommandArgument="<%# Container.DataItemIndex %>" CssClass="btn buttonColorGridview" OnClick="btnViewDeputyDirector_Click" ToolTip="View Details"><i class="fa fa-search"></i></asp:LinkButton>
                                                                                </ItemTemplate>
                                                                            </asp:TemplateField>
                                                                            <asp:BoundField DataField="id" HeaderText="id" />
                                                                            <asp:BoundField DataField="catalog_type" HeaderText="Catalog Type" />
                                                                    ...
                                                                    <asp:GridView ID="TableHistoryDeputyDirectorApproval" runat="server" CssClass="table table-striped row-border order-column table-bordered nowrap zero-configuration" AutoGenerateColumns="False" Style="width: 100%"
                                                                        ...
                                                                        <Columns>
                                                                            <asp:TemplateField HeaderText="Action">
                                                                                ...
                                                                                <ItemStyle CssClass="fixed-column" />
                                                                                <ItemTemplate>
                                                                                    <asp:LinkButton runat="server" ID="btnViewHistoryDeputyDirector" CommandName="Lihat" CommandArgument="<%# Container.DataItemIndex %>" CssClass="btn buttonColorGridview" OnClick="btnViewHistoryDeputyDirector_Click" ToolTip="View Details"><i class="fa fa-search"></i></asp:LinkButton>
                                                                                </ItemTemplate>
                                                                            </asp:TemplateField>
                                                                            <asp:BoundField DataField="id" HeaderText="id" />
                                                                            <asp:BoundField DataField="rf_no" HeaderText="RF Number" />
                                                                    ...
                                                                    <asp:GridView ID="TableDirectorAdminApproval" runat="server" CssClass="table table-striped row-border order-column table-bordered nowrap zero-configuration grid" AutoGenerateColumns="False" Style="width: 100%"
                                                                        ...
                                                                        <Columns>
                                                                            <asp:TemplateField HeaderText="Action">
                                                                                ...
                                                                                <ItemStyle CssClass="fixed-column" />
                                                                                <ItemTemplate>
                                                                                    <asp:LinkButton runat="server" ID="btnViewDirectorAdminApproval" CommandName="Lihat" CommandArgument="<%# Container.DataItemIndex %>" CssClass="btn buttonColorGridview" OnClick="btnViewDirectorAdminApproval_Click" ToolTip="View Details"><i class="fa fa-search"></i></asp:LinkButton>
                                                                                </ItemTemplate>
                                                                            </asp:TemplateField>
                                                                            <asp:BoundField DataField="id" HeaderText="id" />
                                                                            <asp:BoundField DataField="catalog_type" HeaderText="Catalog Type" />
                                                                    ...
                                                                    <asp:GridView ID="TableHistoryDirectorAdminApproval" runat="server" CssClass="table table-striped row-border order-column table-bordered nowrap zero-configuration grid" AutoGenerateColumns="False" Style="width: 100%"
                                                                        ...
                                                                        <Columns>
                                                                            <asp:TemplateField HeaderText="Action">
                                                                                ...
                                                                                <ItemStyle CssClass="fixed-column" />
                                                                                <ItemTemplate>
                                                                                    <asp:LinkButton runat="server" ID="btnViewHistoryDirectorAdmin" CommandName="Lihat" CommandArgument="<%# Container.DataItemIndex %>" CssClass="btn buttonColorGridview" OnClick="btnViewHistoryDirectorAdmin_Click" ToolTip="View Details"><i class="fa fa-search"></i></asp:LinkButton>
                                                                                </ItemTemplate>
                                                                            </asp:TemplateField>
                                                                            <asp:BoundField DataField="id" HeaderText="id" />
                                                                            <asp:BoundField DataField="rf_no" HeaderText="RF Number" />
