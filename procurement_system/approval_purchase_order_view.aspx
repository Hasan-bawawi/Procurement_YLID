<%@ Page Title="Approval Purchase Order (PO)" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="approval_purchase_order_view.aspx.cs" Inherits="procurement_system.approval_purchase_order_view" Async="true" %>
    ...
    <script type="text/javascript">
        function FuncSave() {
            swal({
                ...
                function redirect() {
                    window.location.href = 'approval_purchase_order.aspx';
                }
            );
        }
    </script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="page-head">
        <div id="page-title">
            <h1 class="page-header text-overflow" style="color: white;">View Purchase Order (PO)</h1>
        </div>
        <ol class="breadcrumb">
            ...
            <li><a href="approval_purchase_order.aspx">&nbsp;Approval Purchase Order (PO)</a></li>
            <li class="active">&nbsp;&nbsp;<i class="fa fa-caret-right"></i></li>
            <li class="active">&nbsp;&nbsp;View Purchase Order (PO) - 
...
<%--                                                        <div class='col-sm-12'>
                            ...
                            <div class='col-sm-12'>
                                <fieldset class="scheduler-border">
                                    <legend class="scheduler-border"><i class="fa-solid fa-file-lines"></i><span class="nav-text">&nbsp;Request Details</span></legend>
                                    <div class="control-group">
                                        <div class="row">
                                            <div class='col-sm-12'>
