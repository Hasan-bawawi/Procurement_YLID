<%@ Page Title="Items" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="item.aspx.cs" Inherits="procurement_system.item" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        function UploadSuccess() {
            swal({
                ...
                function redirect() {
                    window.location.href = 'item.aspx';
                }
            );
        }
    </script>
    <script type="text/javascript">
        function FuncSave() {
            swal({
                title: 'Save Success',
                text: 'Data Item Successfully Submit',
                timer: '2000',
                type: 'success',
                showConfirmButton: false,
                html: true
    ...
    <script type="text/javascript">
        function FuncDelete() {
            swal({
                ...
                text: 'Data Item Successfully Deleted',
                timer: '2000',
                type: 'success',
                showConfirmButton: false,
                html: true
    ...
    <script type="text/javascript">
        function DuplicateItemName() {
            swal('Save Failed!', 'Item name already exist!', 'error');
        }
    </script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="page-head">
        <div id="page-title">
            <h1 class="page-header text-overflow" style="color: white;">Item</h1>
        </div>
        <ol class="breadcrumb">
                        ...
                        <div class="row">
                            <div class='col-sm-12'>
                                <fieldset class="scheduler-border">
                                    <legend class="scheduler-border">List of Item</legend>
                                    <div class='col-sm-12'>
                                    ...
                                    <div class='col-sm-12'>
                                        <asp:GridView ID="TableItems" runat="server" CssClass="table table-striped table-bordered zero-configuration nowrap grid" AutoGenerateColumns="False" Style="width: 100%"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class='col-sm-12'>
                            <fieldset class="scheduler-border">
                                <legend class="scheduler-border">Item Views</legend>
                                <div class="row">
                                    <div class='col-sm-12' hidden>
                                        Code
										<div class="form-group">
                                            <div class='input-group'>
                                                <input runat="server" id="txtCode" data-validate-length-range="5,15" type="text" class="form-control input-rounded" placeholder="Type Item Name" disabled>
                                            </div>
                                        </div>
                                    </div>
                                    <div class='col-sm-12'>
										...
										<div class="form-group">
                                            <div class='input-group'>
                                                <input runat="server" id="txtItem" data-validate-length-range="5,15" type="text" class="form-control input-rounded" placeholder="Type Item Name">
                                            </div>
                                        </div>
                                    </div>
                                    <div class='col-sm-6'>
